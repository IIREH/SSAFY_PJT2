...
class UserServiceImplTest {
    ...
    public void 로그인() throws Exception{
        ...
        // when
        User findUser = userRepository.findUserByEmail(user.getSocialId()).get(0);
    ...
    public void 회원탈퇴() throws Exception{
        ...
        // when
        List<User> userList_before = userRepository.findUserByEmail(user.getSocialId());
        userService.deleteUser(user.getEmail());
        List<User> userList_after = userRepository.findUserByEmail(user.getSocialId());
